...
namespace cbbl {
    ...
    mapnik::image_rgba8 render(const std::string &map_dir, int z, int x, int y, int tile_scale, const std::optional<std::string> &buffer, int dz, int dx, int dy, int metatile_zdiff);
}
